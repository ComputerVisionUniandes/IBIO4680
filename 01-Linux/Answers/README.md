...
Figure 7. General command for users and shells.

The command used was compposed of several parts:

1. Cut: This command is used to process text.

2. Sort: Sorts text according to some column, in this case the second one.

3. Expand: With this command we can give some format to the output.
...
Figure 8. Results of duplicate images.

![p6](ImagesLab1/p6.png)

Figure 9. Source code to finde duplicate images.

Therefore, this is the code source that we use:
```
...
Figure 10. Image segmentation database files.

The files were downloaded from:

[Berkeley, Computer Vision Group](https://www2.eecs.berkeley.edu/Research/Projects/CS/vision/grouping/resources.html#bsds500).
...
Figure 11. Disk size of dataset.

The size of the directory is 72M.

![p9](ImagesLab1/p9.png)

Figure 12. General images files in the concerning folder.

The number of images files in the folder are 505.

## 8. What is their resolution, what is their format?

Using  imageMagick we can obtain the next results:

![p10](ImagesLab1/p10.png)

Figure 13. Format and resolutions of the images files.
...
Figure 14. Results of images in *landscape* orientations.

Using image Magick we can know the size of each image, with find we can detect each image file (*.gif, *.jpg, *.png, et al.).

In order to employ this, we determined that there are 351 landscape and 154 portrait images.
...
Figure 15. The squaring commads of images.

Here you could find the code of square images to (256x256):
```
...
In the next image we can observe an example that the size of each image is effectively 256x256.

![p13](ImagesLab1/p13.png)

Figure 16. Example result of the size of the images files.
